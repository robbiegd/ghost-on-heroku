(function() {
  ...
  // inlineCSSDark-RTL
  gulp.task('inlinecssdark-rtl', function(done) {
    return gulp.src(['partials/inline-css-dark-rtl.hbs'])
    .pipe(replace('@@compiled_css_dark_rtl', fs.readFileSync('assets/css/dark-min-rtl.css')))
    .pipe(gulp.dest('partials/compiled'))
    done();
  });
  ...
  gulp.task(
    'build_css',
    gulp.series('sass', 'inlinecss', 'inlinecssdark', 'inlinecss-rtl', 'inlinecssdark-rtl')
  );
